...
function DashboardLayout(props) {
  return (
    <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
      <aside class="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-[#1C2434]">
        ...
        <div class="sidebar-content px-4 py-6">
          <ul class="flex flex-col w-full">
            ...
            <li class="my-px">
              <a
                href="#"
                class="flex flex-row items-center h-10 px-3 rounded-sm text-gray-300 hover:bg-gray-700 hover:text-gray-300"
              >
                <span class="flex items-center justify-center text-lg text-gray-400">
                  <svg
                    fill="none"
