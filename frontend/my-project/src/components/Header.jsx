  ...
  <div class="flex items-center justify-between mx-auto max-w-7xl">
    ...
    <div class="flex items-center space-x-1">
      <div class="hidden space-x-1 md:inline-flex">
        ...
        <Link to="/register" class="btn btn-sm btn-link">Register</Link>
      </div>
      <Link to="/login" class="btn btn-sm btn-primary">Sign In</Link>
      <div class="inline-flex md:hidden" x-data="{ open: false }">
        ...
        >
          <button class="self-end flex-none px-2 ml-2 btn btn-link btn-icon" //</div>@click="open = false"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <Link to="/register" class="w-full btn btn-link">Register</Link>
          <Link href="/login" class="w-full btn btn-link">Sign In</Link>
        </div>
      </div>
    </div>
  </div>
